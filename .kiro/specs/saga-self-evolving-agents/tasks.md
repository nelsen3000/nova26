...
- [ ] 1. Set up project structure and core types
  - [ ] 1.1 Create `src/saga/` directory and define core TypeScript interfaces
  ...
  - [ ] 1.2 Add Convex schema extensions for SAGA tables
  ...
  - [ ] 1.3 Implement GoalGenome serialization and deserialization
  ...
  - [ ]* 1.4 Write property test for GoalGenome serialization round-trip
...
- [ ] 2. Implement Goal Mutation operations
  - [ ] 2.1 Create `src/saga/goal-mutator.ts` with all mutation operations
  ...
  - [ ]* 2.2 Write property test for add objective mutation
    - **Property 6: Add objective mutation**
    - **Validates: Requirements 4.1**

  - [ ]* 2.3 Write property test for remove objective mutation
    - **Property 7: Remove objective mutation**
    - **Validates: Requirements 4.2**

  - [ ]* 2.4 Write property test for perturb objective mutation
    - **Property 8: Perturb objective mutation**
    - **Validates: Requirements 4.3**

  - [ ]* 2.5 Write property test for recombine mutation
    - **Property 9: Recombine mutation**
    - **Validates: Requirements 4.4**

  - [ ]* 2.6 Write property test for mutation invariants
...
- [ ] 3. Implement Fitness Evaluator and Tournament Selection
  - [ ] 3.1 Create `src/saga/fitness-evaluator.ts`
  ...
  - [ ]* 3.2 Write property test for fitness summary completeness
    - **Property 2: Inner Loop fitness summary completeness**
    - **Validates: Requirements 2.2, 2.3**

  - [ ]* 3.3 Write property test for tournament selection
...
- [ ] 5. Implement Taste Guard
  - [ ] 5.1 Create `src/saga/taste-guard.ts`
  ...
  - [ ]* 5.2 Write property test for Taste Guard filtering
    - **Property 11: Taste Guard filtering**
    - **Validates: Requirements 5.1, 5.2, 5.4**

  - [ ]* 5.3 Write property test for Taste-rejected candidates excluded from selection
    - **Property 12: Taste-rejected candidates excluded from selection**
    - **Validates: Requirements 5.3**

- [ ] 6. Implement Curriculum Generator
  - [ ] 6.1 Create `src/saga/curriculum-generator.ts`
  ...
  - [ ]* 6.2 Write property test for curriculum topological ordering
    - **Property 13: Curriculum topological ordering**
    - **Validates: Requirements 6.1, 6.2**

  - [ ]* 6.3 Write property test for curriculum task result recording
    - **Property 14: Curriculum task result recording**
    - **Validates: Requirements 6.3**

- [ ] 7. Implement Inner Loop
  - [ ] 7.1 Create `src/saga/inner-loop.ts`
...
- [ ] 8. Implement Outer Loop
  - [ ] 8.1 Create `src/saga/outer-loop.ts`
  ...
  - [ ]* 8.2 Write property test for lineage graph reachability
    - **Property 5: Lineage graph reachability**
    - **Validates: Requirements 3.6**

  - [ ]* 8.3 Write property test for candidate generation from population
...
- [ ] 10. Implement ATLAS Goal Store
  - [ ] 10.1 Create `convex/saga.ts` with Convex mutations and queries
  ...
  - [ ] 10.2 Create `src/saga/atlas-goal-store.ts` as the TypeScript client wrapper
  ...
  - [ ]* 10.3 Write property test for ATLAS Goal Store persistence completeness
    - **Property 17: ATLAS Goal Store persistence completeness**
    - **Validates: Requirements 8.1, 8.3**

  - [ ]* 10.4 Write property test for ATLAS Goal Store retention pruning
    - **Property 18: ATLAS Goal Store retention pruning**
    - **Validates: Requirements 8.5**

  - [ ]* 10.5 Write property test for notable fitness logging
    - **Property 19: Notable fitness logging**
    - **Validates: Requirements 8.4**

- [ ] 11. Implement Session Manager
  - [ ] 11.1 Create `src/saga/session-manager.ts`
  ...
  - [ ]* 11.2 Write property test for budget enforcement
  ...
  - [ ]* 11.4 Write property test for population size invariant
...
- [ ] 13. Implement Autonomy Gating and Swarm Debate
  - [ ] 13.1 Create `src/saga/autonomy-gating.ts`
  ...
  - [ ] 13.2 Create `src/saga/swarm-debate.ts`
  ...
  - [ ]* 13.3 Write property test for autonomy-level evolution gating
    - **Property 20: Autonomy-level evolution gating**
    - **Validates: Requirements 9.1, 9.5, 10.3, 10.4, 10.5**

  - [ ]* 13.4 Write property test for Swarm Debate score incorporation
    - **Property 21: Swarm Debate score incorporation**
    - **Validates: Requirements 9.2, 9.3**

  - [ ]* 13.5 Write property test for Swarm Debate consensus rejection
    - **Property 22: Swarm Debate consensus rejection**
    - **Validates: Requirements 9.4**

- [ ] 14. Implement Overnight Evolution and Portfolio Learning
  - [ ] 14.1 Create `src/saga/overnight-evolution.ts`
  ...
  - [ ] 14.2 Create `src/saga/portfolio-learning.ts`
  ...
  - [ ]* 14.3 Write property test for auto-checkpoint frequency
    - **Property 23: Auto-checkpoint frequency**
    - **Validates: Requirements 10.2**

  - [ ]* 14.4 Write property test for overnight evolution summary completeness
    - **Property 24: Overnight evolution summary completeness**
    - **Validates: Requirements 10.6**

  - [ ]* 14.5 Write property test for portfolio seed population limit
    - **Property 25: Portfolio seed population limit**
    - **Validates: Requirements 11.3**

  - [ ]* 14.6 Write property test for cross-project learning logging
    - **Property 26: Cross-project learning logging**
    - **Validates: Requirements 11.4**

- [ ] 15. Wire SAGA Engine top-level coordinator
  - [ ] 15.1 Create `src/saga/saga-engine.ts`
  ...
  - [ ] 15.2 Create `src/saga/index.ts` barrel export
