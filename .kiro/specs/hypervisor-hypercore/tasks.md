...
- [ ] 1. Set up project structure and core types
  ...
  - [ ] 1.2 Create `src/hypervisor/index.ts` barrel export file
    - _Requirements: all_
...
- [ ] 4. Implement HypervisorManager core lifecycle
  ...
  - [ ] 4.2 Implement VM spawn and terminate in HypervisorManager
...
- [ ] 11. Implement observability and health monitoring
  - [ ] 11.1 Create `src/hypervisor/observer.ts` with HypervisorObserver class
...
- [ ] 15. Wire everything together and integrate with existing Nova26 modules
  ...
  - [ ] 15.5 Update `src/hypervisor/index.ts` barrel exports with all public APIs
    - _Requirements: all_
